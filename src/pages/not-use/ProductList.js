...
// sections
import { ProductTableRow, ProductTableToolbar } from '../../sections/@dashboard/products/product-list';
...
export default function ProductList() {
  ...
  const handleEditRow = (id) => {
    navigate(PATH_DASHBOARD.products.edit(paramCase(id)));
  };
  ...
  return (
    <Page title="Products: Product List">
        ...
        <HeaderBreadcrumbs
          ...
          action={
            <Button
              ...
              to={PATH_DASHBOARD.products.new}
            >
              New Product
            </Button>
          }
