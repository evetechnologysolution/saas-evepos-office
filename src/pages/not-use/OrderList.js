...
// sections
import { OrderTableToolbar, OrderTableRow } from '../../sections/@dashboard/order';
...
const TABLE_HEAD = [
  ...
  { id: 'time', label: 'Jam', align: 'left' },
  { id: 'table', label: 'Table', align: 'left' },
  { id: 'order', label: 'Order', align: 'left' },
  { id: 'totalPrice', label: 'Total', align: 'left' },
