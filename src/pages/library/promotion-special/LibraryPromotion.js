...
// section
import { PromotionTableToolbar, PromotionTableRow } from "../../../sections/@dashboard/library/promotion-special";
...
const TABLE_HEAD = [
  ...
  { id: "selectedDay", label: "Selected Day", align: "center" },
...
export default function PromotionList() {
  ...
  const getData = async ({ queryKey }) => {
    ...
    try {
      const res = await axios.get(`/special-promotions?${queryString}`);
  ...
  const handleEditRow = (id) => {
    navigate(PATH_DASHBOARD.library.specialPromotionEdit(paramCase(id)));
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(`/special-promotions/${selectedId}`);
      enqueueSnackbar("Delete success!");
      client.invalidateQueries("listSpecialPromotion");
          ...
          <Card>
            ...
            >
              ...
              <Button
                ...
                to={PATH_DASHBOARD.library.specialPromotionCreate}
              >
                New Promotion
              </Button>
            </Stack>
