...
// section
import { VoucherTableToolbar, VoucherTableRow } from "../../../sections/@dashboard/library/voucher";
...
export default function VoucherList() {
  ...
  const handleEditRow = (id) => {
    navigate(PATH_DASHBOARD.library.voucherEdit(paramCase(id)));
  };
  ...
  const handleDelete = async () => {
    ...
    if (selectedId) {
      ...
      client.invalidateQueries("listVoucher");
          ...
          <Card>
            ...
            >
              <div style={{ minWidth: "40%" }}>
                <VoucherTableToolbar filterName={search} onFilterName={handleSearch} onEnter={handleOnKeyPress} />
              </div>
              <Button
                variant="contained"
                startIcon={<Iconify icon="eva:plus-fill" />}
                component={RouterLink}
                to={PATH_DASHBOARD.library.voucherCreate}
              >
                New Voucher
              </Button>
            </Stack>
