...
// sections
import { LogVoucherTableToolbar, LogVoucherTableRow } from "../../../sections/@dashboard/member/log-voucher";
...
export default function MemberLogVoucher() {
  const {
    dense,
    onChangeDense,
  } = useTable();
          ...
          <Card>
            ...
            >
              <div style={{ minWidth: "40%" }}>
                <LogVoucherTableToolbar filterName={search} onFilterName={handleSearch} onEnter={handleOnKeyPress} />
              </div>
            </Stack>
