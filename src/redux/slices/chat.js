...
export function getContacts() {
  return async () => {
    ...
    try {
      const response = await axios.get('https://api-dev-minimal-v630.pages.dev/api/chat?endpoint=contacts');
...
export function getConversations() {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.get('https://api-dev-minimal-v630.pages.dev/api/chat?endpoint=conversations');
...
export function getConversation(conversationKey) {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      // const response = await axios.get('https://api-dev-minimal-v630.pages.dev/api/chat/conversation', {
      //   params: { conversationKey },
      // });
      const response = await axios.get('https://api-dev-minimal-v630.pages.dev/api/chat', {
        params: { conversationId: conversationKey, endpoint: "conversation" },
      });
...
export function markConversationAsRead(conversationId) {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      await axios.get('https://api-dev-minimal-v630.pages.dev/api/chat/conversation/mark-as-seen', {
...
export function getParticipants(conversationKey) {
  return async () => {
    dispatch(slice.actions.startLoading());
    try {
      const response = await axios.get('https://api-dev-minimal-v630.pages.dev/api/chat/participants', {
        params: { conversationKey },
      });
