...
export default function ChatRoomOneParticipant({ member, isCollapse, onCollapse }) {
  ...
  return (
    <>
      ...
      >
        <Avatar alt={member?.name} src="" sx={{ width: 96, height: 96 }} />
      ...
      <Collapse in={isCollapse}>
        <Box sx={{ px: 2.5, pb: 1 }}>
          <RowStyle>
            ...
            <RowTextStyle>{member?.address}</RowTextStyle>
          </RowStyle>
          <RowStyle>
            <RowIconStyle icon={"eva:phone-fill"} />
            <RowTextStyle>{member?.phone}</RowTextStyle>
          </RowStyle>
          <RowStyle>
            <RowIconStyle icon={"eva:email-fill"} />
            <RowTextStyle>{member?.email}</RowTextStyle>
          </RowStyle>
        </Box>
      </Collapse>
    </>
